...
function executar(dados) {
  ...
  d3.json(dados).then(function(x) {
    ...
    // menu de opções
    var paineis = [{ "painel": "Masculino", "id": "bMasculino", "funcao": "gerarPainel(dados, this.id)" },
                   { "painel": "Feminino", "id": "bFeminino", "funcao": "gerarPainel(dados, this.id)" }];
...
function gerarPainel(dados, botao) {
